        ...
        <div class="footer-section">
            <div class="about">
                ...
                <div class="social-media">
                    ...
                    <a href="">
                        <svg width="96" height="auto" viewBox="0 0 1024 1024" class="social-media-icon">
                    ...
                    <a href="">
                        <svg  width="96" height="auto" viewBox="0 0 24 24" class="social-media-icon">
                    ...
                    <a href="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="96" height="auto" viewBox="0 0 24 24" class="social-media-icon">
	                        <path d="M0 0h24v24H0z" fill="none" />
                    ...
                    <a href="">
                        <svg  viewBox="0 0 24 24" class="social-media-icon">
                            <g fill="none">
                                <g clip-path="url(#SVGXv8lpc2Y)">
            ...
            <div class="quick-links">
                ...
                <hr>
                    ...
                    <div class="shows">
                        ...
                        <a href="weeklyshows.php">Our Shows</a>
                    </div>
                    <div class="voices">
                        ...
                        <a href="../Pages/theTeam.php">The Voices</a>
                    </div>
                    <div class="news">
                        <svg width="96" height="auto" viewBox="0 0 24 24" class="description-icon-small">
                            <path d="M0 0h24v24H0z" fill="none" />
